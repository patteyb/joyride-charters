...
<a href="https://www.pinterest.com/compassrose88/" class="icon">
<span><?php esc_html_e( 'Pinterest', 'Divi' ); ?></span>
</a>
</li>

<li class="et-social-icon et-social-instagram">
<a href="https://www.instagram.com/joyridecharters/" class="icon">
<span><?php esc_html_e( 'Instagram', 'Divi' ); ?></span>
</a>
</li>

<li class="et-social-icon et-social-linkedin">
<a href="https://www.linkedin.com/m/login/" class="icon">
